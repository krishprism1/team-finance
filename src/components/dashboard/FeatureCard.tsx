...
const FeatureCard: React.FC<FeatureCardProps> = (props) => {
    return (
        <div className="column2">
            ...
            <div className="links">
                <div><a href="#">{props.btnOne}<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" className="arrow-right" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="m11.293 17.293 1.414 1.414L19.414 12l-6.707-6.707-1.414 1.414L15.586 11H6v2h9.586z"></path></svg></a></div>
