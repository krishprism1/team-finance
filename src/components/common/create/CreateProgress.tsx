    ...
    return (
        <>
            ...
            <div className="token-creation-bar">
                ...
                <div className="column1" style={{ display: step > 0 ? '' : 'none' }}>
                    ...
                    <div className='content'>
                        ...
                        <span className='span5'>Connect wallet</span>
                    </div>
                </div>


                <div className="column row2" style={{ display: step > 1 ? 'none' : '' }}>
                    <button className={step == 1 ? "btn-radio2-active" : "btn-radio2"}></button>
                    <div className='content'>
                ...
                <div className="column2" style={{ display: step > 1 ? '' : 'none' }}>
                    <button className='green-radio2'></button>
                    <div className='content'>
                        <img src="https://app.team.finance/_next/static/media/check-circle.e19b6900.svg" className='radio-bar-img5' alt="" />
                        <span className='span5'>Select blockchain</span>
                    </div>
                </div>


                <div className="column row3" style={{ display: step > 2 ? 'none' : '' }}>
                    <button className={step == 2 ? "btn-radio3-active" : "btn-radio3"}></button>
                    <div className='content'>
                ...
                <div className="column3" style={{ display: step > 2 ? '' : 'none' }}>
                    <button className='green-radio3'></button>
                    <div className='content'>
                        <img src="https://app.team.finance/_next/static/media/check-circle.e19b6900.svg" className='radio-bar-img5' alt="" />
                        <span className='span5'>Enter token info</span>
                    </div>
                </div>


                <div className="column row4" style={{ display: step > 3 ? 'none' : '' }}>
                    <button className={step == 3 ? "btn-radio4-active" : "btn-radio4"}></button>
                    <div className='content'>
                ...
                <div className="column4" style={{ display: step > 3 ? '' : 'none' }}>
                    <button className='green-radio4'></button>
                    <div className='content'>
                        <img src="https://app.team.finance/_next/static/media/check-circle.e19b6900.svg" className='radio-bar-img5' alt="" />
                        <span className='span5'>Add features</span>
                    </div>
                </div>


                <div className="column row5" style={{ display: step > 4 ? 'none' : '' }}>
                    <button className={step == 4 ? "btn-radio5-active" : "btn-radio5"}></button>
                    <div className='content'>
                ...
                <div className="column5" style={{ display: step > 4 ? '' : 'none' }}>
