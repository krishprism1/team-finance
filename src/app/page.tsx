            ...
            <div className="securty-level-bar-container">
              ...
              <div className="level-heading-column">
                    <div className="first-box1">
                      ...
                      <p>You have made it. Nice job!</p>
                    </div>
                    <div className="second-box2">
                      <div className="small-box">
                        <div className="box1"><div className="done-arrow"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="m10 15.586-3.293-3.293-1.414 1.414L10 18.414l9.707-9.707-1.414-1.414z"></path></svg></div>
                        <p>Token vesting</p></div>
                        <div className="box2"><div className="done-arrow"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="m10 15.586-3.293-3.293-1.414 1.414L10 18.414l9.707-9.707-1.414-1.414z"></path></svg></div>
                          <p>Team token locks</p></div>
                        <div className="box3"><div className="done-arrow"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="m10 15.586-3.293-3.293-1.414 1.414L10 18.414l9.707-9.707-1.414-1.414z"></path></svg></div>
