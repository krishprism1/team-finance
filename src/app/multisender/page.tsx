                ...
                <div className="select-blockchain-box">
                    ...
                    {step == 4 && (
                        <div className="create-contract-container">
                            <h3>Send token</h3>
                            <p>Please give your permissions to use this token. It's a one-time action per sender wallet. If you modify the spend cap in your wallet, reauthorization is required.</p>
